...
menu_models() {
    ...
    echo "  5) Tutti i modelli"
    echo "  6) Nessuno (salta)"
    echo ""
    ...
    case "$choice" in
        ...
        5) download_gpt2=true; download_llama=true; download_llama32=true; download_qwen25=true ;;
        6) ;;
...
if [ $# -gt 0 ]; then
    for arg in "$@"; do
        case $arg in
            ...
            --all)     DOWNLOAD_GPT2=true; DOWNLOAD_LLAMA=true; DOWNLOAD_LLAMA32=true; DOWNLOAD_QWEN25=true ;;
...
[ -f "$MODEL_DIR/llama-3.2-3b.Q4_K_M.gguf" ] || [ -f "$MODEL_DIR/qwen2.5-1.5b.Q4_K_M.gguf" ] || [ -f "$MODEL_DIR/tinyllama.Q4_K_M.gguf" ] && echo "║    # poi apri http://localhost:8080       ║"
echo "║                                           ║"
echo "╚═══════════════════════════════════════════╝"
echo ""
